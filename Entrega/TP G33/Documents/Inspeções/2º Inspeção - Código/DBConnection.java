...
public class DBConnection {
    ...
    public void removeUser(User user) {
        ...
        try {
            String sql = "DELETE FROM User WHERE idUser = ? AND licensePlate= ?";
    ...
    public ArrayList<Integer> getFreeParkingSpaces(Park park) {
        ...
        try {
            String sql = "SELECT IdParkingSpace FROM ParkingSpace WHERE IdPark = " + park.getIdPark() + " AND Reserved = " + false;
            resultSet = statement.executeQuery(sql);
